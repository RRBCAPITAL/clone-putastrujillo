...
const Footer = () => {
  return (
    <div className={quick.className}>
      <footer className="flex flex-col items-center justify-center text-t-red-l bg-violet-900 pt-[2rem] lg:pt-[5rem] text-[1rem]">
        <div className="grid sm:grid-cols-4 mx-10 lg:mx-20 gap-10 sm:gap-40">
          <div className="footer-1">
            <Link href={"/"} className="flex flex-col gap-4 max-w-[300px]">
              <h1 className="text-2xl font-extrabold">
                Kinesiólogas Arequipa kinesvip
              </h1>
              <h2>
                Anuncios de kinesiólogas en Arequipa,
                Cusco, Tacna, Apurimac, Madre de Dios, Ucayali, Junin, Ica y
                Moquegua.
              </h2>
            </Link>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-1">
              <li>
                <Link href={"/"}>Kinesiologas</Link>
              </li>
              <li>
                <Link href={"/sign-in"}>Iniciar sesión</Link>
              </li>
              <li>
                <Link href={"/crear-anuncio"}>Crear anuncio</Link>
              </li>
              <li>
                <Link href={"/activar-anuncio"}>Planes de publicación</Link>
              </li>
            </ul>
          </div>
            ...
            <ul className="flex flex-col gap-4">
              ...
              <li>
                <Link
                  target="_blank"
                  href={
                    "https://drive.google.com/file/d/1H1T-qnLR4bL4JWBkqTff3pnf8qfCqUA_/view"
                  }
                >
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4">
              <p className="sm:text-[10px] lg:text-[16px]">
                rrbcapital24@gmail.com
              </p>
              {/* <h3>Mensaje :</h3>
            ...
            <ul className="socials flex gap-2">
              <li>
                <Link
                  target="_blank"
                  href={"https://www.instagram.com/papayahub_pe/"}
                  className="flex gap-1"
                >
                  <h1>IG</h1>
                  <SiInstagram className="my-auto" />
                </Link>
              </li>
              <li>
                <Link
        ...
        <div className="text-center mt-[4rem] py-[0.8rem] mx-auto border-t border-slate-500 w-screen">
          <small>Copyright &copy; Kinesvip 2024</small>
        </div>
      </footer>
    </div>
  );
